...
class Customer:
    def __init__(self, cid, cname):
        ...
        self.bonus_point = 0     #보너스포인트
        self.bonus_ratio = 0.01  #보너스 적립율 - 1%

    def getname(self):      # cnamed이 접근 불가이므로 함수로 가져옴
        return self._cname

    def calc_price(self, price):  # 보너스 포인트 = 상품각격 x 보너스 적립율
...
class GoldCustomer(Customer):    #Customer 상속
    def __init__(self,cid, cname):
